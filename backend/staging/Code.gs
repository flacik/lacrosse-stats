// ═══════════════════════════════════════════════════════════════════════════════
// Lacrosse Stats v2 — Google Apps Script backend — STAGING
// ═══════════════════════════════════════════════════════════════════════════════
//
// Środowisko testowe — zawsze IS_DEV: false, celuje w arkusz DEV ligi.
// Używaj do weryfikacji zmian PRZED deployem na ligę i reprezentację.
// Nie dotyka danych produkcyjnych.
//
// Setup: uruchom setupSheets() raz z edytora GAS po pierwszym deploymencie.
...
var CONFIG = {
  // Staging celuje w arkusz DEV ligi — nigdy w prod
  PROD_SPREADSHEET_ID: '1ah9GhGJYby_lZxyG4VzNGN7GRkykiMm2fwe16arON_Q',
  DEV_SPREADSHEET_ID:  '1ah9GhGJYby_lZxyG4VzNGN7GRkykiMm2fwe16arON_Q',

  // Zawsze false — staging zachowuje się jak prod, ale na danych testowych
  IS_DEV: false,
